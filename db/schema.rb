...
ActiveRecord::Schema.define(version: 20160805135031) do
  ...
  create_table "competition_results", force: :cascade do |t|
    ...
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.index ["athlete_id"], name: "index_competition_results_on_athlete_id", using: :btree
  ...
  add_foreign_key "competition_results", "athletes"
